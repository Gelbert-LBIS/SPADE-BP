classdef PIStages < handle
    ...
    methods
        ...
        function status = connect(this)%CHECKED %DONE
            try
                ...
                for i =1:this.vars.numOfDevices
                    ...
                    % this.availableAxes(id) =
                    % this.devCntl{id}.qSAIasArray(); %function removed
                    this.availableAxes{id} = this.devCntl{id}.qSAI_ALL;
        ...
        function stopGil(this)
            this.devCntl{1}.STP();
            this.devCntl{2}.STP();
            this.devCntl{3}.STP();
        end
        
        function moveRelGil(this, id, rel)
            this.devCntl{id}.MOV('1', this.devCntl{id}.qPOS('1')+rel);
        end
        
        function moveAbsGil(this, id, pos)
            this.devCntl{id}.MOV('1', pos);
        end
