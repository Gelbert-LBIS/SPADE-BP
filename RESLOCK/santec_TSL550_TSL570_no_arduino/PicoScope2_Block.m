classdef PicoScope2_Block < handle
    ...
    methods (Access = public)
        ...
        function setup(this,ts,durationMS)
            ...
            invoke(this.triggerGroupObj, 'setSimpleTrigger', 1, 1000, 0, 0, 0);
            %% Channels
            ...
            invoke(this.ps2000DeviceObj, 'ps2000SetChannel', 0, 1, 1, 7);
            invoke(this.ps2000DeviceObj, 'ps2000SetChannel', 1, 1, 1, 8);
            %% Block settings
        ...
        function [chA, chB] = read(this)
            ...
            if sum(overflow(:))
                warning('PicoScope Over voltage! adjust channel scale');
            end
        end
